(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "intern!object", "intern/chai!assert", "src/util/environment", "../../../_support/loadModule", "sinon"], factory);
    }
    ...
    registerSuite({
        ...
        beforeEach: function () {
            module = loadModule_1.default('src/util/environment', {
                fs: {
